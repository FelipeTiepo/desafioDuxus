...
public class IntegranteService {
    ...
    public IntegranteDTO update(Long id, IntegranteDTO dto) {
        try {
            Integrante integrante = repository.getById(id);
    ...
    private void copyDtoToEntity(IntegranteDTO dto, Integrante entity) {
        ...
        entity.setComposicaoTime(dto.getTime().getComposicaoTime());

        entity.getComposicaoTime().clear();
        for(ComposicaoTime item: dto.getTime().getComposicaoTime()){
            ComposicaoTime composicaoTime = composicaoTimeRepository.getById(dto.getId());
